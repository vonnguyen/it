...
class ProductController extends Controller
{
    ...
    function list(){
        ...
        return view('admin.product.list',compact("listProduct"));  // truyen du lieu vao danh muc
    }
    // Hien thi add
    function showadd(){
        return view('admin.product.add');
    ...
    function showupdate($id){
        ...
        return view('admin.product.update',compact('cate')); // truyen du lieu vao danh muc
    }
    // xoa
    function delete($id){
